...
import { detectEvents } from "./voicing.js?v=0.4.10";
import { nameChord } from "./chordName.js?v=0.4.10";
import { chordConsonance, chordConsonanceByDegree, noteNameToPc, rootDegreeNumber } from "./consonance.js?v=0.4.10";
import { keyAt } from "./keyDetect.js?v=0.4.10";
